/**
 * site-config.js — Best Bathroom Storage
...
window.SITE_CONFIG = {
  ...
  footer: {
    description: "Your trusted source for bathroom storage reviews, comparisons, and buying guides. Find the perfect storage solutions to maximize every inch of your bathroom.",
    quickLinks: [
